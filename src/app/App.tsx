...
const initialProposals: Proposal[] = [
   {
     ...
     description: 'Renovar el parque local con nueva equipación de juegos infantiles, senderos para caminar y espacios verdes para que disfrute la familia.',
     author: 'María Santos',
     authorAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Maria',
     neighborhood: 'Centro',
     category: 'Parques y Recreación',
     budget: 150000,
     votes: 342,
     comments: 28,
   ...
   {
     id: '2',
     title: 'Nuevos Carriles Bici en Calle Principal',
     description: 'Instalar carriles bici protegidos para mejorar la seguridad de los ciclistas y fomentar el transporte sostenible en el centro.',
     author: 'Juan Chen',
   ...
   {
     id: '3',
     title: 'Iniciativa de Huerto Urbano',
     description: 'Crear huertos comunitarios para que los residentes locales cultiven verduras y se conecten con los vecinos.',
   ...
   {
     id: '4',
     title: 'Actualización Tecnológica de la Biblioteca Pública',
     description: 'Modernizar la biblioteca con nuevas computadoras, internet de alta velocidad y recursos de aprendizaje digital para todas las edades.',
     author: 'David Kim',
     authorAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=David',
     neighborhood: 'Lado Este',
     category: 'Educación',
     budget: 200000,
     votes: 456,
     comments: 52,
   ...
   {
     id: '5',
     title: 'Mejora de Iluminación Callejera',
     description: 'Instalar luces LED de bajo consumo en las calles para mejorar la seguridad y reducir los costos de energía.',
     author: 'Sofía Martínez',
     authorAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Sofia',
     neighborhood: 'Lado Oeste',
     category: 'Infraestructura',
     budget: 120000,
     votes: 198,
     comments: 16,
     ...
     technicalFeedback: 'La zona de ejecución propuesta corresponde a una vialidad estatal fuera del ámbito municipal.',
     suggestedModifications: 'Redefinir el polígono del proyecto a vialidades bajo jurisdicción municipal y volver a enviar.',
     daysLeft: 8,
   ...
   {
     id: '6',
     title: 'Expansión del Centro Comunitario',
     description: 'Expandir el centro comunitario local con nuevas salas multiusos para clases, eventos y reuniones comunitarias.',
     author: 'Miguel Brown',
     authorAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Michael',
     neighborhood: 'Colinas del Norte',
     category: 'Comunidad',
     budget: 350000,
     votes: 612,
     comments: 78,
     ...
     suggestedModifications: 'Dividir el proyecto en etapas y presentar una versión ajustada al límite de presupuesto.',
     daysLeft: 15,
...
export default function App() {
  ...
  const applyAiWritingAssist = (proposalId: string) => {
    const draft = getWorkspaceDraft(proposalId);
    const improved = `${draft.description.trim()}\n\nVersión mejorada con IA: Esta propuesta prioriza evidencia territorial, impacto comunitario medible y viabilidad institucional.`;
